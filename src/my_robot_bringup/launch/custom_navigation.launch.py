...
def generate_launch_description():
    ...
    pkg_custom_nav = get_package_share_directory('my_robot_driver') # Ensure this is your navigation scripts package
    ...
    tank_navigator_node = Node(
        ...
        parameters=[{
            'use_sim_time': use_sim_time,
            'max_linear_speed': 0.014,
            'min_approach_linear_speed': 0.010,
            'max_angular_speed_align': 0.18,
            'max_angular_speed_drive': 0.06,
            'min_active_angular_speed': 0.05,
            'kp_linear': 0.15,
            'kp_angular_align': 0.8,
